...
description: >
  ...
  雪球/股票行情, RSS feeds, novels (Qidian, Novel543, 69shuba), or any web URL.
  ...
  分类：search / social (小红书/推特/B站/V2EX/Reddit) / career(LinkedIn) / dev(github) / web(网页/文章/RSS) / video(YouTube/B站/播客) / novel(小说)。
triggers:
  ...
  - novel: qidian/novel543/69shu/69shuba/小说/网文/修仙小说/都市小说/章节/读书
metadata:
  openclaw:
