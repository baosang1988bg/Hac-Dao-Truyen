 ...
 * URL truyện Trung muốn dịch (POST /api/novel-requests). Dùng chung
 * components/ui/Modal.jsx cho phần overlay/Escape/focus trap, chỉ tự style
 * nội dung theo màu sắc --glass-bg/--border/--accent-gradient.
 *
